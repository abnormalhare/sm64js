...
export const GFX_DIMENSIONS_ASPECT_RATIO = 4.0 / 3.0;

export const GFX_DIMENSIONS_FULL_RADIUS = SCREEN_HEIGHT * (GFX_DIMENSIONS_ASPECT_RATIO > 1 ? GFX_DIMENSIONS_ASPECT_RATIO : 1);