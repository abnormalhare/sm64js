import { CALC_DXT, gdSPDefLights1, gsDPLoadBlock, gsDPLoadSync, gsDPPipeSync, gsDPSetAlphaCompare, gsDPSetCombineMode, gsDPSetEnvColor, gsDPSetRenderMode, gsDPSetTextureImage, gsDPSetTile, gsDPSetTileSize, gsDPTileSync, gsSP1Triangle, gsSP2Triangles, gsSPClearGeometryMode, gsSPDisplayList, gsSPEndDisplayList, gsSPLight, gsSPSetGeometryMode, gsSPTexture, gsSPVertex, G_AC_NONE, G_CC_MODULATERGBFADE, G_CC_SHADE, G_CC_SHADEFADEA, G_CULL_BACK, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_IM_SIZ_16b_BYTES, G_OFF, G_ON, G_RM_AA_ZB_XLU_SURF, G_RM_CUSTOM_AA_ZB_XLU_SURF, G_RM_NOOP2, G_TEXTURE_IMAGE_FRAC, G_TX_CLAMP, G_TX_LOADTILE, G_TX_NOLOD, G_TX_NOMASK, G_TX_NOMIRROR, G_TX_RENDERTILE, G_TX_WRAP } from "../../include/gbi"

// ** actors/peach/model
const peach_seg5_lights_050009F8 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x05000A10
const peach_seg5_lights_05000A10 = gdSPDefLights1(
    0x7f, 0x5f, 0x0c,
...
export const peach_seg5_dl_05005648 = [
    ...
    gsSPVertex(peach_seg5_vertex_05004828, 15, 0),
...
export const peach_seg5_dl_05005750 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach_seg5_texture_05002A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 16 * 16 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
const peach_seg5_lights_05005FA0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05006138 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

const peach_seg5_lights_05006150 = gdSPDefLights1(
    0x6c, 0x54, 0x5f,
...
const peach_seg5_lights_05006A90 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05007288 = gdSPDefLights1(
    0x7f, 0x5f, 0x0c,
    0xff, 0xbf, 0x18, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05007AE0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05007EB0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05008280 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_050085D0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_050087D0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05008B20 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05008D20 = gdSPDefLights1(
    0x0b, 0x1a, 0x67,
...
const peach_seg5_lights_05008F48 = gdSPDefLights1(
    0x0b, 0x1a, 0x67,
    0x16, 0x35, 0xce, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05009170 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05009528 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
...
const peach_seg5_lights_05009968 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)
