import { GEO_ANIMATED_PART, GEO_ASM, GEO_BRANCH, GEO_CLOSE_NODE, GEO_DISPLAY_LIST, GEO_END, GEO_NODE_START, GEO_OPEN_NODE, GEO_RETURN, GEO_SCALE, GEO_SHADOW, GEO_SWITCH_CASE, LAYER_OPAQUE, LAYER_TRANSPARENT } from "../../engine/GeoLayout"
...
export const peach_geo_000098 = () => {return [
   GEO_NODE_START(),
   GEO_OPEN_NODE(),
...
export const peach_geo_000254 = () => {return [
    GEO_NODE_START(),
    GEO_OPEN_NODE(),
